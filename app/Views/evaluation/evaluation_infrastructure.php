...
<div class="container-fluid">
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?= esc($activity['activity_code'] ?? 'Infrastructure Activity') ?></li>
                </ol>
            </nav>
        </div>
        <div>
    ...
    <div class="evaluation-header">
        <h1 style="color: #ffc107; margin-bottom: 10px;">INFRASTRUCTURE ACTIVITY EVALUATION REPORT</h1>
    ...
    <div class="card mb-4">
        <div class="card-header bg-warning text-dark">
            <h5 class="mb-0"><i class="fas fa-building"></i> Infrastructure Activity Overview</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <!-- Basic Information -->
                <div class="col-md-6">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><span class="badge bg-warning text-dark fs-6"><?= esc($activity['activity_code'] ?? 'N/A') ?></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>Activity Type</th>
                            <td><span class="badge bg-warning text-dark fs-6">Infrastructure</span></td>
                        </tr>
                        <tr>
                            <th>Workplan</th>
                            <td>
                ...
                <div class="col-md-6">
                    <h6><i class="fas fa-chart-bar"></i> Infrastructure Targets</h6>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="card border-warning">
                                <div class="card-body text-center">
                                    <h6 class="card-title text-warning">Quarter 1</h6>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card border-warning">
                                <div class="card-body text-center">
                                    <h6 class="card-title text-warning">Quarter 2</h6>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card border-warning">
                                <div class="card-body text-center">
                                    <h6 class="card-title text-warning">Quarter 4</h6>
                    ...
                    <div class="mt-3">
                        <div class="card bg-light">
                            <div class="card-body">
                                <h6><i class="fas fa-chart-pie"></i> Infrastructure Summary</h6>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Infrastructure Budget:</strong> <?= $activity['total_budget'] ? number_format($activity['total_budget'], 2) : 'N/A' ?></p>
                                        <p><strong>Total Proposals:</strong> <span class="badge bg-warning text-dark"><?= $proposalSummary['total'] ?></span></p>
                                    </div>
                                    <div class="col-md-6">
            ...
            <div class="mt-4">
                <h6><i class="fas fa-file-text"></i> Infrastructure Description</h6>
    ...
    <!-- Infrastructure Proposals and Implementation Details -->
    <div class="card">
        <div class="card-header bg-warning text-dark">
            <h5 class="mb-0"><i class="fas fa-hammer"></i> Infrastructure Proposals - Implementation Details</h5>
            <small>Approved or rated infrastructure proposals with full implementation details</small>
        </div>
        <div class="card-body">
            <?php if (empty($proposals)): ?>
                <div class="alert alert-warning">
                    <i class="fas fa-exclamation-triangle"></i> No approved or rated infrastructure proposals found for this activity.
                </div>
            <?php else: ?>
                    ...
                    <div class="proposal-section mb-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="text-warning">
                                <i class="fas fa-building"></i> Infrastructure Proposal #<?= $index + 1 ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="card border-warning">
                                    <div class="card-header bg-warning text-dark">
                                        <h6 class="mb-0"><i class="fas fa-info-circle"></i> Infrastructure Information</h6>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-sm">
                                            <tr>
                                                <th style="width: 40%">Construction Period</th>
                                                <td>
                        ...
                        <!-- Infrastructure Implementation Activities -->
                        <?php if (!empty($proposal['implementations'])): ?>
                            <div class="implementations-section">
                                <h6 class="text-warning mb-3">
                                    <i class="fas fa-hammer"></i> Infrastructure Implementation Details
                                    <span class="badge bg-warning text-dark"><?= count($proposal['implementations']) ?></span>
                                </h6>
                                    ...
                                    <?php if ($implementation['type'] === 'Infrastructure'): ?>
                                        <div class="card mb-4 border-warning">
                                            <div class="card-header bg-light">
                                                <h6 class="mb-0">
                                                    <span class="badge bg-warning text-dark">Infrastructure Construction</span>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        ...
                                                        <?php if (!empty($implementation['infrastructure'])): ?>
                                                            <div class="mb-3">
                                                                <h6><i class="fas fa-building"></i> Infrastructure Description</h6>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="card bg-light">
                                                            <div class="card-body">
                                                                <h6><i class="fas fa-hammer"></i> Construction Info</h6>
                                                                ...
                                                                <p><strong><i class="fas fa-clock"></i> Construction Date:</strong><br>
                                                                ...
                                                                <?php if (!empty($implementation['signing_sheet_filepath'])): ?>
                                                                    ...
                                                                    <a href="<?= base_url($implementation['signing_sheet_filepath']) ?>" target="_blank" class="btn btn-sm btn-outline-warning">
                                                        ...
                                                        <?php if (!empty($implementation['infrastructure_images'])): ?>
                                                            <div class="card bg-light mt-3">
                                                                <div class="card-body">
                                                                    <h6><i class="fas fa-images"></i> Construction Photos</h6>
                                                                    <?php
                                                                    $images = is_string($implementation['infrastructure_images']) ? json_decode($implementation['infrastructure_images'], true) : $implementation['infrastructure_images'];
                                                        ...
                                                        <?php if (!empty($implementation['infrastructure_files'])): ?>
                                                            <div class="card bg-light mt-3">
                                                                <div class="card-body">
                                                                    <h6><i class="fas fa-file-alt"></i> Construction Documents</h6>
                                                                    <?php
                                                                    $files = is_string($implementation['infrastructure_files']) ? json_decode($implementation['infrastructure_files'], true) : $implementation['infrastructure_files'];
                                                ...
                                                <?php if (!empty($implementation['remarks'])): ?>
                                                    <div class="mt-3">
                                                        <h6><i class="fas fa-comment"></i> Construction Remarks</h6>
                        ...
                        <?php else: ?>
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle"></i> No infrastructure implementation activities recorded for this proposal yet.
                            </div>
                        <?php endif; ?>

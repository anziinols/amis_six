    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h6><i class="fas fa-target"></i> Target Output</h6>
                    <div class="row">
                        <div class="col-12 mb-2">
                            <div class="card border-primary">
                                <div class="card-body text-center p-3">
                                    <small class="text-primary">Expected Output</small>
                                    <p class="mb-0 fw-bold"><?= esc($activity['target_output'] ?? 'Not specified') ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <form action="<?= base_url('evaluation/' . $activity['id'] . '/rate') ?>" method="post">
        ...
        <div class="card mb-4">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="fas fa-chart-line"></i> Activity Progress</h5>
                <small>Track the progress and status of this activity</small>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="progress_notes" name="progress_notes" rows="3"
                                      placeholder="Enter any progress notes or updates for this activity"><?= old('progress_notes', $activity['status_remarks'] ?? '') ?></textarea>
                            <div class="form-text">Document any progress, challenges, or updates for this activity</div>
                        </div>
                    </div>
                </div>
            </div>

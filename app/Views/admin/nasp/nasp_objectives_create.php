...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>
            ...
            Add New Objective for Specific Area: <?= esc($specificArea['title']) ?> (<?= esc($specificArea['code']) ?>)
        </h5>
    </div>
    <div class="card-body">
        ...
        <form action="<?= base_url('admin/nasp-plans/apas/' . $apa['id'] . '/dips/' . $dip['id'] . '/specific-areas/' . $specificArea['id'] . '/objectives') ?>" method="post">
            <?= csrf_field() ?>

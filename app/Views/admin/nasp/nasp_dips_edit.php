        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit DIP</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0">Edit DIP: <?= esc($dip['code']) ?></h3>
                    <div>
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/nasp-plans/apas/' . $dip['parent_id'] . '/dips/' . $dip['id']) ?>" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" value="<?= old('code', esc($dip['code'])) ?>" required>
                        </div>

                        <div class="form-group mb-3">
                            <label for="title" class="form-label">Title <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="title" name="title" value="<?= old('title', esc($dip['title'])) ?>" required>
                        </div>

                        <div class="form-group mb-3">
                            <label for="remarks" class="form-label">Remarks</label>
                            <textarea class="form-control" id="remarks" name="remarks" rows="3"><?= old('remarks', esc($dip['remarks'])) ?></textarea>
                        </div>

                        <div class="d-flex justify-content-end">
                            <a href="<?= base_url('admin/nasp-plans/apas/' . $dip['parent_id'] . '/dips') ?>" class="btn btn-secondary me-2">Cancel</a>

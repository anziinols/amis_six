        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create New Specific Area</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?= base_url('admin/mtdp-plans/dips/' . $dip['id'] . '/specific-areas') ?>" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/mtdp-plans/specific-areas') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sa_code" name="sa_code" value="<?= old('sa_code') ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sa_title" class="form-label">Specific Area Title <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="sa_title" name="sa_title" value="<?= old('sa_title') ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="sa_remarks" name="sa_remarks" rows="4"><?= old('sa_remarks') ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Save Specific Area
                                </button>
                                <a href="<?= base_url('admin/mtdp-plans/dips/' . $dip['id'] . '/specific-areas') ?>" class="btn btn-secondary">

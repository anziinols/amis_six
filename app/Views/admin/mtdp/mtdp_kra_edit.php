    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/mtdp-plans/kras/' . $kra['id']) ?>" method="post">
                        <?= csrf_field() ?>

                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="kpi" class="form-label">Key Performance Indicator (KPI) <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="kpi" name="kpi" rows="3" required><?= old('kpi', $kra['kpi']) ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="responsible_agencies" name="responsible_agencies" rows="3"><?= old('responsible_agencies', $kra['responsible_agencies']) ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" id="year_one" name="year_one" value="<?= old('year_one', $kra['year_one']) ?>">
                            </div>
                            <div class="col-md-2">
                                <label for="year_two" class="form-label">Year 2</label>
                                <input type="text" class="form-control" id="year_two" name="year_two" value="<?= old('year_two', $kra['year_two']) ?>">
                            </div>
                            <div class="col-md-2">
                                <label for="year_three" class="form-label">Year 3</label>
                                <input type="text" class="form-control" id="year_three" name="year_three" value="<?= old('year_three', $kra['year_three']) ?>">
                            </div>
                            <div class="col-md-2">
                                <label for="year_four" class="form-label">Year 4</label>
                                <input type="text" class="form-control" id="year_four" name="year_four" value="<?= old('year_four', $kra['year_four']) ?>">
                            </div>
                            <div class="col-md-2">
                                <label for="year_five" class="form-label">Year 5</label>
                                <input type="text" class="form-control" id="year_five" name="year_five" value="<?= old('year_five', $kra['year_five']) ?>">
                            </div>
                        </div>

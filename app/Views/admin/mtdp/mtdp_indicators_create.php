            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?= base_url('admin/mtdp-plans/strategies/' . $strategy['id'] . '/indicators') ?>" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/mtdp-plans/indicators') ?>" method="post">
                        <?= csrf_field() ?>
                        <input type="hidden" name="strategies_id" value="<?= $strategy['id'] ?>">

                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="indicator" class="form-label">Indicator <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="indicator" name="indicator" rows="3" required><?= old('indicator') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="baseline" name="baseline" value="<?= old('baseline') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="year_one" name="year_one" value="<?= old('year_one') ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="year_two" class="form-label">Year Two</label>
                                <input type="text" class="form-control" id="year_two" name="year_two" value="<?= old('year_two') ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="year_three" class="form-label">Year Three</label>
                                <input type="text" class="form-control" id="year_three" name="year_three" value="<?= old('year_three') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="year_four" name="year_four" value="<?= old('year_four') ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="year_five" class="form-label">Year Five</label>
                                <input type="text" class="form-control" id="year_five" name="year_five" value="<?= old('year_five') ?>">
                            </div>
                        </div>

        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title mb-0">Supervise Output Activity: <?= esc($activity['activity_title']) ?></h5>
                </div>
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <p class="mb-1"><strong>Type:</strong> <span class="badge bg-danger"><?= ucfirst(esc($activity['type'])) ?></span></p>
                                        </div>
                                        <div class="col-md-4">
                    ...
                    <?php if ($implementationData): ?>
                        <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <p>Output activity implementation details will be displayed here.</p>
